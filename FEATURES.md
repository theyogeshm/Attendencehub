...
- [x] Overall Attendance Summary (Total Attended, Total Held, Aggregate %) filtered per semester (working)
...
- [x] Semester-wise attendance data storage and filtering (Semesters 1-8 stay isolated) (working)
...
- [x] Date-specific scheduled class list modal for past dates filtered by exact day-of-week timetable schedule (working)
